...
public class SubjectSelector extends JFrame {
	...
	public SubjectSelector() {
		...
		JTextPane txtpnEnEstaSeccion = new JTextPane();
		txtpnEnEstaSeccion.setFont(new Font("Arial", Font.PLAIN, 12));
		txtpnEnEstaSeccion.setText("\r\n\r\nEn esta seccion, usted va a poder agregar sus materias. Escriba cada una de ellas separadas por c\u00F3mas.\r\n\r\nEjemplo: \r\n\r\nMatem\u00E1ticas, F\u00EDsica, Literatura, etcetera.");
		txtpnEnEstaSeccion.setBackground(new Color(0, 0, 0));
		txtpnEnEstaSeccion.setForeground(new Color(255, 255, 255));
		txtpnEnEstaSeccion.setEditable(false);
		txtpnEnEstaSeccion.setBounds(200, 0, 234, 261);
		contentPane.add(txtpnEnEstaSeccion);
